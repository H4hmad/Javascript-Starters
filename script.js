...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-11-02T17:01:17.194Z',
    '2024-11-08T08:36:17.929Z',
...
const startLogOutTimer = () => {
  const tick = () => {
    ...
    if (time === 0) {
      clearInterval(timer);
      labelWelcome.textContent = `Logg in to get started.`;
...
// console.log(Math.max(5, 2, 4, 6, 7, 12, 23, 4, 34));
// console.log(Math.min(5, 2, 4, 6, 7, 12, 23, 4, 34));
